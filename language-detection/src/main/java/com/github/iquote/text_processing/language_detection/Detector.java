...
/**
 * <p>
 * {@link com.github.iquote.text_processing.language_detection.Detector} class is to detect language from specified text.
 * Its instance is able to be constructed via the factory class {@link DetectorFactory}.
 * </p>
 * <p>
 * After appending a target text to the {@link com.github.iquote.text_processing.language_detection.Detector} instance with {@link #append(String)},
...
public class Detector {
     ...
     * If the total size of target text exceeds the limit size specified by {@link com.github.iquote.text_processing.language_detection.Detector#setMaxTextLength(int)},
